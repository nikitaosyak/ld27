...
class Boss extends FlxSprite implements IHitable {
    ...
    public function new(x:Float, y:Float, state:LevelBase) {
        ...
        this.animation.add(ANIM_MOVE, [0, 1, 2, 3], 5);
        this.animation.add(ANIM_ATTACK, [0, 0, 4, 5, 6, 7, 8, 8, 8, 8], 7);
        this.animation.add(ANIM_ATTACK2, [4, 5, 6, 7, 7, 6, 5, 4, 4], 13);
        this.animation.add(ANIM_DEATH, [12, 13, 14, 15, 15, 15, 15, 15, 15, 16, 17, 18, 19, 20, 20, 20], 5);
        this.animation.add(ANIM_STAGGER, [12, 14, 14, 14], 6);
        this.animation.add(ANIM_APPEAR, [20, 19, 18, 17, 16, 15, 14, 13, 12, 12, 0, 0, 0], 5);
