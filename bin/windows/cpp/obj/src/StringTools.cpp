...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_PUSH("StringTools::urlEncode","C:\\haxe\\haxe/std/StringTools.hx",37);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(37)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_PUSH("StringTools::urlDecode","C:\\haxe\\haxe/std/StringTools.hx",62);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(62)
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_PUSH("StringTools::startsWith","C:\\haxe\\haxe/std/StringTools.hx",124);
	HX_STACK_ARG(s,"s");
...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_PUSH("StringTools::isSpace","C:\\haxe\\haxe/std/StringTools.hx",162);
	HX_STACK_ARG(s,"s");
...
::String StringTools_obj::ltrim( ::String s){
	HX_STACK_PUSH("StringTools::ltrim","C:\\haxe\\haxe/std/StringTools.hx",176);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(180)
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_PUSH("StringTools::rtrim","C:\\haxe\\haxe/std/StringTools.hx",201);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(205)
	int l = s.length;		HX_STACK_VAR(l,"l");
	HX_STACK_LINE(206)
...
::String StringTools_obj::trim( ::String s){
	HX_STACK_PUSH("StringTools::trim","C:\\haxe\\haxe/std/StringTools.hx",223);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(223)
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_PUSH("StringTools::replace","C:\\haxe\\haxe/std/StringTools.hx",288);
	HX_STACK_ARG(s,"s");
