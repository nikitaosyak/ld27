...
{
HX_STACK_PUSH("List::new","C:\\haxe\\haxe/std/List.hx",40);
{
	HX_STACK_LINE(40)
	this->length = (int)0;
}
...
Dynamic List_obj::iterator( ){
	HX_STACK_PUSH("List::iterator","C:\\haxe\\haxe/std/List.hx",161);
	HX_STACK_THIS(this);
	struct _Function_1_1{
		inline static Dynamic Block( ::List_obj *__this){
			HX_STACK_PUSH("*::closure","C:\\haxe\\haxe/std/List.hx",179);
			{
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_1","C:\\haxe\\haxe/std/List.hx",181);
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_2","C:\\haxe\\haxe/std/List.hx",184);
					HX_STACK_THIS(__this.mPtr);
					{
						HX_STACK_LINE(186)
...
bool List_obj::remove( Dynamic v){
	HX_STACK_PUSH("List::remove","C:\\haxe\\haxe/std/List.hx",138);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(139)
...
bool List_obj::isEmpty( ){
	HX_STACK_PUSH("List::isEmpty","C:\\haxe\\haxe/std/List.hx",114);
	HX_STACK_THIS(this);
	HX_STACK_LINE(114)
	return (this->h == null());
}
...
{
		HX_STACK_PUSH("List::push","C:\\haxe\\haxe/std/List.hx",64);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("List::add","C:\\haxe\\haxe/std/List.hx",49);
		HX_STACK_THIS(this);
		HX_STACK_ARG(item,"item");
		HX_STACK_LINE(50)
