...
{
HX_STACK_PUSH("Main::new","Main.hx",17);
{
	HX_STACK_LINE(18)
	super::__construct();
	HX_STACK_LINE(20)
...
{
		HX_STACK_PUSH("Main::init","Main.hx",28);
		HX_STACK_THIS(this);
		HX_STACK_ARG(e,"e");
		HX_STACK_LINE(29)
		...
		HX_STACK_LINE(36)
		this->addChild(::flx::Game_obj::__new());
		HX_STACK_LINE(37)
		this->addChild(::openfl::display::FPS_obj::__new((int)10,(int)10,(int)16777215));
	}
return null();
}
...
Void Main_obj::main( ){
{
		HX_STACK_PUSH("Main::main","Main.hx",13);
		HX_STACK_LINE(13)
