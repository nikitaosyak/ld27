...
Void Listener_obj::__construct(Dynamic listener,bool useCapture,int priority)
{
HX_STACK_PUSH("Listener::new","flash/events/EventDispatcher.hx",247);
{
	HX_STACK_LINE(249)
...
hx::ObjectPtr< Listener_obj > Listener_obj::__new(Dynamic listener,bool useCapture,int priority)
...
bool Listener_obj::is( Dynamic listener,bool useCapture){
	HX_STACK_PUSH("Listener::is","flash/events/EventDispatcher.hx",264);
	HX_STACK_THIS(this);
	HX_STACK_ARG(listener,"listener");
	HX_STACK_ARG(useCapture,"useCapture");
	HX_STACK_LINE(264)
	return (bool(::Reflect_obj::compareMethods(this->listener_dyn(),listener)) && bool((this->useCapture == useCapture)));
}
...
{
		HX_STACK_PUSH("Listener::dispatchEvent","flash/events/EventDispatcher.hx",257);
		HX_STACK_THIS(this);
