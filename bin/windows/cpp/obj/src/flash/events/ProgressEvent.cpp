...
{
HX_STACK_PUSH("ProgressEvent::new","flash/events/ProgressEvent.hx",14);
...
::String ProgressEvent_obj::toString( ){
	HX_STACK_PUSH("ProgressEvent::toString","flash/events/ProgressEvent.hx",31);
	HX_STACK_THIS(this);
	HX_STACK_LINE(31)
...
::flash::events::Event ProgressEvent_obj::clone( ){
	HX_STACK_PUSH("ProgressEvent::clone","flash/events/ProgressEvent.hx",24);
	HX_STACK_THIS(this);
	HX_STACK_LINE(24)
	return ::flash::events::ProgressEvent_obj::__new(this->get_type(),this->get_bubbles(),this->get_cancelable(),this->bytesLoaded,this->bytesTotal);
}
