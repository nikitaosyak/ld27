...
{
HX_STACK_PUSH("Date::new","C:\\haxe\\haxe/std/cpp/_std/Date.hx",26);
{
	HX_STACK_LINE(26)
...
::String Date_obj::toString( ){
	HX_STACK_PUSH("Date::toString","C:\\haxe\\haxe/std/cpp/_std/Date.hx",48);
	HX_STACK_THIS(this);
	HX_STACK_LINE(48)
...
::Date Date_obj::fromString( ::String s){
	HX_STACK_PUSH("Date::fromString","C:\\haxe\\haxe/std/cpp/_std/Date.hx",60);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(61)
	switch( (int)(s.length)){
		case (int)8: {
