...
{
HX_STACK_PUSH("Bytes::new","C:\\haxe\\haxe/std/haxe/io/Bytes.hx",29);
{
	HX_STACK_LINE(30)
	this->length = length;
	HX_STACK_LINE(31)
...
::String Bytes_obj::toString( ){
	HX_STACK_PUSH("Bytes::toString","C:\\haxe\\haxe/std/haxe/io/Bytes.hx",211);
	HX_STACK_THIS(this);
	HX_STACK_LINE(211)
...
::String Bytes_obj::readString( int pos,int len){
	HX_STACK_PUSH("Bytes::readString","C:\\haxe\\haxe/std/haxe/io/Bytes.hx",163);
	HX_STACK_THIS(this);
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_PUSH("Bytes::sub","C:\\haxe\\haxe/std/haxe/io/Bytes.hx",99);
	HX_STACK_THIS(this);
	HX_STACK_ARG(pos,"pos");
	HX_STACK_ARG(len,"len");
	HX_STACK_LINE(101)
...
{
		HX_STACK_PUSH("Bytes::blit","C:\\haxe\\haxe/std/haxe/io/Bytes.hx",68);
		HX_STACK_THIS(this);
		HX_STACK_ARG(pos,"pos");
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_PUSH("Bytes::alloc","C:\\haxe\\haxe/std/haxe/io/Bytes.hx",250);
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_PUSH("Bytes::ofString","C:\\haxe\\haxe/std/haxe/io/Bytes.hx",275);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(286)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(287)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_PUSH("Bytes::ofData","C:\\haxe\\haxe/std/haxe/io/Bytes.hx",324);
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(324)
