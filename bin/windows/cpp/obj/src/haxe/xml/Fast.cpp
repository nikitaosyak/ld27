...
{
HX_STACK_PUSH("Fast::new","C:\\haxe\\haxe/std/haxe/xml/Fast.hx",122);
{
	HX_STACK_LINE(123)
...
::String Fast_obj::get_innerData( ){
	HX_STACK_PUSH("Fast::get_innerData","C:\\haxe\\haxe/std/haxe/xml/Fast.hx",137);
	HX_STACK_THIS(this);
	HX_STACK_LINE(138)
...
::String Fast_obj::get_name( ){
	HX_STACK_PUSH("Fast::get_name","C:\\haxe\\haxe/std/haxe/xml/Fast.hx",133);
	HX_STACK_THIS(this);
	HX_STACK_LINE(133)
