...
{
HX_STACK_PUSH("ObjectMap::new","C:\\haxe\\haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",29);
{
	HX_STACK_LINE(29)
...
Dynamic ObjectMap_obj::keys( ){
	HX_STACK_PUSH("ObjectMap::keys","C:\\haxe\\haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_LINE(50)
...
Dynamic ObjectMap_obj::get( Dynamic key){
	HX_STACK_PUSH("ObjectMap::get","C:\\haxe\\haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",37);
	HX_STACK_THIS(this);
