...
{
HX_STACK_PUSH("TiledPropertySet::new","flixel/addons/editors/tiled/TiledPropertySet.hx",13);
{
	HX_STACK_LINE(13)
	this->keys = ::haxe::ds::StringMap_obj::__new();
}
;
	return null();
}
...
{
		HX_STACK_PUSH("TiledPropertySet::extend","flixel/addons/editors/tiled/TiledPropertySet.hx",38);
		HX_STACK_THIS(this);
		...
		for(::cpp::FastIterator_obj< ::haxe::xml::Fast > *__it = ::cpp::CreateFastIterator< ::haxe::xml::Fast >(Source->nodes->resolve(HX_CSTRING("property"))->iterator());  __it->hasNext(); ){
			...
			this->keys->set(prop1->att->resolve(HX_CSTRING("name")),prop1->att->resolve(HX_CSTRING("value")));
		}
	}
return null();
}
...
Dynamic TiledPropertySet_obj::keysIterator( ){
	HX_STACK_PUSH("TiledPropertySet::keysIterator","flixel/addons/editors/tiled/TiledPropertySet.hx",33);
	HX_STACK_THIS(this);
	HX_STACK_LINE(33)
...
::String TiledPropertySet_obj::resolve( ::String Name){
	HX_STACK_PUSH("TiledPropertySet::resolve","flixel/addons/editors/tiled/TiledPropertySet.hx",28);
	HX_STACK_THIS(this);
...
bool TiledPropertySet_obj::contains( ::String Key){
	HX_STACK_PUSH("TiledPropertySet::contains","flixel/addons/editors/tiled/TiledPropertySet.hx",23);
	HX_STACK_THIS(this);
...
::String TiledPropertySet_obj::get( ::String Key){
	HX_STACK_PUSH("TiledPropertySet::get","flixel/addons/editors/tiled/TiledPropertySet.hx",18);
	HX_STACK_THIS(this);
	HX_STACK_ARG(Key,"Key");
	HX_STACK_LINE(18)
