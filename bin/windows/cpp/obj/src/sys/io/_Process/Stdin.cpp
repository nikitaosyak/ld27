...
{
HX_STACK_PUSH("Stdin::new","C:\\haxe\\haxe/std/cpp/_std/sys/io/Process.hx",29);
{
	HX_STACK_LINE(30)
	this->p = p;
	HX_STACK_LINE(31)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_PUSH("Stdin::writeBytes","C:\\haxe\\haxe/std/cpp/_std/sys/io/Process.hx",44);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stdin::writeByte","C:\\haxe\\haxe/std/cpp/_std/sys/io/Process.hx",39);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(40)
		this->buf->b[(int)0] = c;
...
{
		HX_STACK_PUSH("Stdin::close","C:\\haxe\\haxe/std/cpp/_std/sys/io/Process.hx",34);
		HX_STACK_THIS(this);
		HX_STACK_LINE(35)
		this->super::close();
		HX_STACK_LINE(36)
