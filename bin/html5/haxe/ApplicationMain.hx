...
class ApplicationMain {
	...
	public static function main() {
		...
		//flash.Lib.setPackage("none", "ld27game", "com.grozamorei.game", "0.0.0");
		...
		loaders.set("assets/an_hero.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/tiled/rock.png", loader);
		total ++;
		
		
		var urlLoader:URLLoader = new URLLoader();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("assets/tiled/testmap.tmx", urlLoader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/tiled/tiles.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/tiled/tree.png", loader);
		total ++;
